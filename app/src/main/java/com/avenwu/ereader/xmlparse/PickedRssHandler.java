...
public class PickedRssHandler extends DefaultHandler {
    private ArrayList<PickedDetailItem> itemList;
    private final String TAG = "RssHandler";
    private PickedDetailItem entryItem;
    ...
    public void startDocument() throws SAXException {
        ...
        itemList = new ArrayList<PickedDetailItem>();
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (qName.equals(Element.entry)) {
            isEntryStarted = true;
            entryItem = new PickedDetailItem();
    ...
    public ArrayList<PickedDetailItem> getEntryItems() {
        return itemList;
    }
}
